...
for (i in 1:num_iterations) {
  capture_names <- paste0("dataset", i)
...
# Save outputs -----------------------------------------------------------------
output_sce_file <- paste0("dataset", i, ".CellRanger.SCE.rds")
output_emptydrops_file <- paste0("dataset", i, "_varying_lower.emptyDrops.rds")
